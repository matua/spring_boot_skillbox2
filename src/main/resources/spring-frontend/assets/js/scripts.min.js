        ...
        var Card = function () {
            var bookTemplate = function (book) {
                ...
                for (const author of book.authors) {
                    let firstName = author.firstName.charAt(0).toUpperCase() + author.firstName.slice(1);
                    let lastName = author.lastName.charAt(0).toUpperCase() + author.lastName.slice(1);
                    authors += `<div class="Card-description"><span>${firstName} ${lastName}</span></div>\n`;
                }
