        ...
        var Card = function () {
            var bookTemplate = function (book) {
                ...
                book.authors.forEach(author => {
                    authors += `<div class="Card-description"><span>${author}</span></div>\n`;
                });
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'popular':
                                ...
                                break;
                            case'genre':
                                getData('/books/genre/' + $this.data('genreslug'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                break;
                            case'author':
                                getData('/books/author/' + $this.data('authorslug'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                break;
                            case'tag':
                                getData('/books/tags/' + $this.data('tagslug'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
            ...
            return {
                init: function () {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/books' + $('#book_to_rate').data('bookid') + '/rateBookReview', data, function (result) {
                            if (result.result) {
        ...
        var ProductCard = function () {
            ...
            return {
                init: function () {
                    ...
                    $ProductAssesment.find('input').on('change', function (e) {
                        var $this = $(this), check = $this.prop('checked');
                        Login().postData('/books' + $('#book_to_rate').data('bookid'),
                            {
